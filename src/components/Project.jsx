...
import pMockup from '../assets/pMockup.png'
  ...
  return (
    <div className='project'>
      <div className="headline">
        <h2>Web Design & UI/UX Overview</h2>
      ...
      <div className="headline" style={{marginTop:'2rem'}}>
        <h2>Data Project Overview</h2>
        <p>All of the project that I currently working / worked on.</p>
      </div>
      <div className="project-wrapper">
      <div className="project-card">
          <div className="header">
            {/* <img src={shLogo} alt="side hustler" className='project-logo'/> */}
            <h4>Parsing Kalimat Bahasa Indonesia</h4>
          </div>
          <img src={pMockup} alt="mockup side hustler" className='project-mockup'/>
          <strong>2024 | Proyek Teori Bahasa dan Automata</strong>
          <p className='project-description'>Aplikasi yang mampu menentukan apakah kalimat bahasa indonesia merupakan bahasa baku atau tidak baku menggunakan CYK Parsing.</p>
          <div className='links'>
            <a href="https://github.com/BismaBendesa/cyk-parsing"><img src={github} alt="Github-links" />Github</a>   
            <a href="https://cyk-parsing-kelompok-2.streamlit.app/"><img src={streamlit} alt="Streamlit-links" />Streamlit</a>
            {/* <a href=""><img src="" alt="" /> Web</a> */}
          </div>
          <div className="footer">
            <div className='like-wrapper'>
